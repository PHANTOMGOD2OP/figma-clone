<div align="center">
  ...
  <h3 align="center">Real Time Figma Clone</h3>
   ...
   <div align="center">
     Build this project step by step with our detailed tutorial on <a href="https://www.youtube.com/@CODEWITHPHANTOM/videos" target="_blank"><b>CODEWITHPHANTOM</b></a> YouTube. Join the CWP family!
    </div>
</div>
...
```bash
git clone https://github.com/PHANTOMGOD2OP/figma-ts.git
cd figma-ts
```
